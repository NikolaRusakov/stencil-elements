    ...
    return (h("div", { class: "wrapper" },
      h("div", { class: "splide" },
        ...
        h("div", { class: "splide__track" },
          h("ul", { class: "splide__list" }, this._videoIds.map(id => (h("li", { class: "splide__slide", "data-splide-youtube": id },
            h("img", { class: "img-thumbnail", src: `https://i3.ytimg.com/vi/${id}/maxresdefault.jpg` })))))))));
  }
  static get is() { return "ds-video-slider"; }
  static get originalStyleUrls() { return {
    "$": ["ds-video-slider.scss"]
  }; }
